...
<div class="breadcrumb-area">
    <div class="container">
        <div class="breadcrumb-content">
            ...
            <ul>
                <li><a href="#">Home</a></li>
                <li class="active">All {{$area_name}}</li>
            </ul>
        </div>
    </div>
</div>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img" src="{{ URL::asset($mech->img)}}" alt="Uren's Product Image" style="height:300px">
                                            <img class="secondary-img" src="{{ URL::asset($mech->img)}}" alt="Uren's Product Image" style="height:300px">
                                        </a>
                                        <div class="sticker">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            ...
                                            <h6><a class="product-name" href="single-product.html">{{$area_name}}</a></h6>
                                            <div class="price-box">
