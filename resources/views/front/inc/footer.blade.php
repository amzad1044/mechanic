                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                <div class="footer-widgets_logo">
                                    <a href="#">
                                        <img src="{{asset('front/assets/images/menu/logo/logo1.png')}}" alt="Uren's Footer Logo">
                                    </a>
                                </div>
                                <div class="widget-short_desc">
                                    <p>We are a team of designers and developers of Mechanic Lagbe?.
                                    </p>
                                </div>
                                    ...
                                    <ul>
                                        <li class="uren-address"><span>Address:</span>
                                         Dhaka,
                                            Dhanmondi, North
                                            City
                                            Corporation 1209, Bangladesh</li>
                                        <li class="uren-phone"><span>Call
                                        Us:</span> <a href="">+880 194 567 4800</a>
                                        </li>
                                        <li class="uren-email"><span>Email:</span> <a href="">info@mechaniclagbe.com</a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">
                                    <span><a href="#">Mechanic Lagbe?</a></span>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="payment">
                                    <a href="#">
                                        <img src="{{asset('front/assets/images/footer/payment/1.png')}}" alt="Uren's Payment Method">
                                    </a>
                                </div>
                            </div>
                        </div>
